...
class QAgent(Agent):
    ...
    def __init__(self, n_states, n_actions,
        ...
        self.eps_decrement = 0.0000011     # wartość, o którą zmniejsza się epsilon po każdym kroku
        self.eps_min = 0.000000001           # końcowa wartość epsilon, poniżej którego już nie jest zmniejszane
